    ...
    function insertarCliente($nif,$nombre,$apellidos,$codPostal,$direccion,$ciudad)
    {
        ...
        try
        {
            ...
            {   
                ...
                print "<h2>Cliente Registrado Correctamente</h2>";
                print "<h2>Las claves de acceso son las siguientes</h2>";
                print "<h2>El usuario es su nombre y la contraseña su apellido escrito de manera inversa</h2>";
            }
