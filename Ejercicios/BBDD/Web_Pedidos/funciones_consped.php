<?php
    ...
    function mostrarInformacionCliente($cliente)
    {
        ...
        try
        {
            ...
            foreach ($resultado as $row) {
                $stmt = $conn->prepare("SELECT orderLineNumber,quantityOrdered,priceEach,productName from orderdetails o,products p where o.orderNumber = :order and productName = productCode");
