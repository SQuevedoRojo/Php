<?php
    ...
    function altaEmpleado($nombre,$ape,$fecNac,$sal,$genero,$departamento,$cargo)
    {
        ...
        try
        {
            ...
            $stmt = $GLOBALS["conn"]->prepare("INSERT INTO employees (emp_no,birth_date,first_name,last_date,gender,hire_date) values (:numEmp,:fec_Nac,:nombre,:ape,:genero,curdate())");
